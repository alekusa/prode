            ...
            <div className="max-w-md w-full space-y-8 glass-panel p-8 rounded-3xl border border-white/5 shadow-2xl animate-fade-in relative z-10">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Unite a la comunidad y empezá a jugar
                    </p>
                </div>

                {success ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center animate-fade-in">
                        <h3 className="text-lg font-bold text-green-400 mb-2">¡Cuenta creada!</h3>
                        <p className="text-sm text-gray-300 mb-4">
                            Por favor revisá tu email para confirmar tu cuenta antes de ingresar.
                        </p>
                        <Link href="/login" className="inline-block px-6 py-2 rounded-lg bg-green-500/20 text-green-400 hover:bg-green-500/30 transition-colors font-medium">
                            Ir al Login
                        </Link>
                    </div>
                ) : (
                ...
                <div className="text-center mt-4">
                    <p className="text-sm text-gray-400">
                        ¿Ya tenés cuenta?{' '}
                        <Link href="/login" className="font-medium text-argentina-blue hover:text-argentina-gold transition-colors">
                            Ingresá acá
                        </Link>
                    </p>
                </div>
